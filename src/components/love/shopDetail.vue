<template>
    <div id="shopDetail">
        ...
        <van-row class="pageSetting">
            ...
            <van-col v-if="goodDetail.shop_info"
                     span="24"
                     class="left title">电话:{{goodDetail.shop_info.user_phone}}</van-col>
        ...
        <van-row class="flo">
            ...
            <van-col offset="8" span="8" class="right" style="display:none">
                <van-button size="small"
                            ...
                            color="#1989fa"
                            type="primary"
                            @click="phoneCall(goodDetail.shop_info.user_phone)">拨打电话</van-button>
            </van-col>
        </van-row>
        <van-row class="plusBox">
            <van-col span="24">
                ...
                <van-button size="normal"
                            ...
                            color="#1989fa"
                            type="primary"
                            @click="submit(goodDetail.id)">立即支付:{{goodDetail.member_price}}元</van-button>
            </van-col>
        </van-row>
    </div>
</template>
